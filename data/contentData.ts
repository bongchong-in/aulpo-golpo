...
export const LIVE_WALL_DATA = {
  label: 'Happening Now',
  title: 'Latest From The Journal',
  footer: 'Powered by Instagram Feed',
  comingSoonText: 'More stories coming soon...',
  items: [
    { id: '1', image: 'https://raw.githubusercontent.com/bongchong-in/aulpo-golpo/refs/heads/main/images/5.jpg', text: '', type: 'image' },
    { id: '2', image: 'https://raw.githubusercontent.com/bongchong-in/aulpo-golpo/refs/heads/main/images/6.jpg', text: '', type: 'image' },
    { id: '3', image: 'https://raw.githubusercontent.com/bongchong-in/aulpo-golpo/refs/heads/main/images/7.jpg', text: '', type: 'image' },
    { id: '4', image: undefined, text: '', type: 'more' }
  ] as WidgetItem[]
};

export const EPILOGUE_DATA = {
